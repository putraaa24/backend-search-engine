...
import type { KeyCreation, Config, IndexOptions, IndexObject, Key, Health, Stats, Version, KeyUpdate, IndexesQuery, IndexesResults, KeysQuery, KeysResults, IndexSwap, MultiSearchParams, FederatedMultiSearchParams, MultiSearchResponseOrSearchResponse, EnqueuedTaskPromise, ExtraRequestInit, Network, RecordAny, RuntimeTogglableFeatures, ResourceResults, SearchRule, SearchRuleUpdatePayload, SearchRuleListPayload, Webhook, ResultsWrapper, WebhookCreatePayload, WebhookUpdatePayload, InitializeNetworkOptions, AddRemoteOptions, RemoveRemoteOptions } from "./types/index.js";
...
export declare class Meilisearch {
     ...
     */
    getDynamicSearchRules(parameters?: SearchRuleListPayload): Promise<ResourceResults<SearchRule[]>>;
    /**
     ...
     */
    getDynamicSearchRule(uid: string): Promise<SearchRule>;
    /**
     ...
     */
    updateDynamicSearchRule(uid: string, rule: SearchRuleUpdatePayload): Promise<SearchRule>;
    /**
     ...
     */
    deleteDynamicSearchRule(uid: string): Promise<void>;
    /**
     * Get all webhooks
     *
